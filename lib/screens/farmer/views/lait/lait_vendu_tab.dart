...
class LaitVenduTab extends StatelessWidget {
  const LaitVenduTab({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Responsive _responsive = Responsive(context);
    return FutureBuilder<List<LaitVenduModel>?>(
        future: LaitRepository.getInstance().getLaitVendu('123456'),
        builder: (context, snapshot) {
          ...
          final List<LaitVenduModel> _cows = snapshot.data!;
          ...
          return Padding(
              ...
              child: DataTable2(
                ...
                rows: [
                  for (final LaitVenduModel cow in _cows)
                    DataRow2(
                      cells: const [
                        DataCell(
                          Text('45/05/2020'),
